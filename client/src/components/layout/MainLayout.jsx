...
import { UserOutlined, LogoutOutlined, SettingOutlined, DashboardOutlined, LoginOutlined, VideoCameraOutlined } from '@ant-design/icons';
    ...
    <Layout style={{ minHeight: '100vh' }}>
      <Header style={{ 
        ...
        <div style={{ display: 'flex', alignItems: 'center' }}>
          <Title level={4} style={{ margin: 0, color: '#000' }}>Edison</Title>
        </div>
