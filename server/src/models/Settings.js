...
settingsSchema.statics.initializeDefaults = async function () {
    const defaultSettings = [
        ...
        },
        {
            ...
            key: 'authMethods',
            value: ['local'],
            description: 'Enabled authentication methods (local, openid)',
        },
        ...
        {
            category: 'security',
            key: 'openidCallbackUrl',
            value: 'http://localhost:3001/api/auth/openid/callback',
        ...
        },
        {
            ...
            description: 'OpenID Connect scopes to request',
        },
        ...
        { category: 'general', key: 'siteName', value: 'Edison', description: 'Site name' },
        {
            category: 'general',
            key: 'siteDescription',
            value: 'Video Management System',
            description: 'Site description',
        },
        {
            category: 'general',
            key: 'contactEmail',
            value: 'support@edison.com',
    ...
    const updates = defaultSettings.map(setting =>
        this.findOneAndUpdate({ category: setting.category, key: setting.key }, setting, {
            upsert: true,
            new: true,
        })
    );
